...
enum Opcodes
{
    ...
    EXTENDED_MATRL_OP					= 135,
    EM_AMBIENT_MAP_OP					= 136,
    EM_DIFFUSE_MAP_OP					= 137,
    EM_SPECULAR_MAP_OP					= 138,
    EM_EMISSIVE_MAP_OP					= 139,
    EM_ALPHA_MAP_OP						= 140,
    EM_LIGHT_MAP_OP						= 141,
    EM_NORMAL_MAP_OP					= 142,
    EM_BUMP_MAP_OP						= 143,
    EM_SHADOW_MAP_OP					= 145,
    EM_REFLECTION_MAP_OP				= 147
};
