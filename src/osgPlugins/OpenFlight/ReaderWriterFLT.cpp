...
USE_FLTRECORD(ExtendedMatrlHdr, EXTENDED_MATRL_OP)
USE_FLTRECORD(EMAmbientMap, EM_AMBIENT_MAP_OP)
USE_FLTRECORD(EMDiffuseMap, EM_DIFFUSE_MAP_OP)
USE_FLTRECORD(EMSpecularMap, EM_SPECULAR_MAP_OP)
USE_FLTRECORD(EMEmissiveMap, EM_EMISSIVE_MAP_OP)
USE_FLTRECORD(EMAlphaMap, EM_ALPHA_MAP_OP)
USE_FLTRECORD(EMLightMap, EM_LIGHT_MAP_OP)
USE_FLTRECORD(EMNormalMap, EM_NORMAL_MAP_OP)
USE_FLTRECORD(EMBumpMap, EM_BUMP_MAP_OP)
USE_FLTRECORD(EMShadowMap, EM_SHADOW_MAP_OP)
USE_FLTRECORD(EMReflectionMap, EM_REFLECTION_MAP_OP)
        ...
        virtual ReadResult readNode(std::istream& fin, const Options* options) const
        {
            ...
            if (options)
            {
                ...
                if (pools)
                {
                    ...
                    if (pools->getExtendedMaterialPool())
                        document.setExtendedMaterialPool( pools->getExtendedMaterialPool(), true );
                }
            }
