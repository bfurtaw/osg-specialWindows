...
public:
    ...
    virtual void addVertex(Vertex& vertex)
    {
        ...
        //OSG_WARN << "\t\taddVertex(vertex) " << std::endl;
        if (isGouraud())
        {
            ...
            if (vertex.validColor())
            {
                ...
                //OSG_WARN << "\t\taddVertex(color) " << std::endl;
            }
            else
            {
                ...
                //OSG_WARN << "\t\taddVertex(primary_clr) " << std::endl;
            }
        }
        ...
        if (strict)
        {
            if (vertex.validNormal())
            {
                ...
                //OSG_WARN << "\t\taddVertex(normal) " << std::endl;
            }
        }
        else
        {
            ...
            if (isLit())
            {
                ...
                else // if lit and no normal in Vertex
                {
                    ...
                    //OSG_WARN << "\t\taddVertex(fake_normal) " << std::endl;
                }
            }
        }
        ...
        for (int layer=0; layer<Vertex::MAX_LAYERS; layer++)
        {
            if (vertex.validUV(layer))
            {
                ...
                //OSG_WARN << "\t\taddVertex(UVs) " << std::endl;
            }
        }
       // OSG_WARN << "\t\tendVertex() " << std::endl;
    }
...
protected:
    ...
    virtual void readRecord(RecordInputStream& in, Document& document)
    {
        ...
        //OSG_WARN << "FaceRecord: Material Index " << materialIndex << " TextureIndex " << textureIndex << std::endl;
		  ...
		  if (isLit() || materialIndex>=0)
        {
            ...
            //OSG_WARN << "FaceRecord is Lit with default material " << materialIndex << std::endl;
        }
...
protected:
    ...
    virtual void readRecord(RecordInputStream& in, Document& document)
    {
        ...
        //OSG_WARN << "MeshRecord: Material Index " << materialIndex << " TextureIndex " << textureIndex << std::endl;
