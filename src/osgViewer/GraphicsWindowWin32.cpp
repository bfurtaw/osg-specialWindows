    ...
    if( 1/*OSG_GL3_FEATURES*/ )
    {
        ...
        else
        {
            ...
            else
            {
				...
				//attribs[idx++] = WGL_CONTEXT_FORWARD_COMPATIBLE_BIT_ARB;  // XXX blf: need for debug reasons
				//attribs[idx++] = WGL_CONTEXT_DEBUG_BIT_ARB;
				attribs[ idx++ ] = WGL_CONTEXT_PROFILE_MASK_ARB;
				attribs[idx++] = WGL_CONTEXT_COMPATIBILITY_PROFILE_BIT_ARB;
#else
                ...
                {
                    OSG_NOTIFY( osg::WARN ) << "GL3: context created successfully." << std::endl;
                }
            }
        }
    }
